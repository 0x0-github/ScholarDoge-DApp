...
import ProjectWallets from "./project-wallets/ProjectWallets";

const TITLE = "ScholarDogeDApp";
const TOKENOMICS_PREFIX = 'tok_';
const REWARDS_PREFIX = 'rew_';
const WALLETS_PREFIX = 'wall_';
            ...
            <div className="App">
                ...
                <BrowserRouter>
                    <Switch>
                        ...
                        <Route path="/project-wallets">
                            <ProjectWallets key={WALLETS_PREFIX + account} account={account}/>
                        </Route>
                        <Route path="/lottery">
                        </Route>
                        <Route path="/team">
